# Generated by Django 3.1.5 on 2021-04-02 07:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='likes', to='network.like')),
            ],
        ),
        migrations.AddField(
            model_name='like',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post', to='network.newpost'),
        ),
        migrations.CreateModel(
            name='Follower',
            fields=[
